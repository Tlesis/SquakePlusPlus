package org.tlesis.squakeplusplus.data;
...
import org.tlesis.squakeplusplus.gui.GuiConfigs.ConfigGuiTab;
import org.tlesis.squakeplusplus.scheduler.TaskScheduler;
...
public class DataManager {
    ...
    private static File getCurrentStorageFile(boolean globalData) {
        ...
        if (dir.exists() == false && dir.mkdirs() == false) {
            SquakePlusPlus.logger.warn("Failed to create the config directory '{}'", dir.getAbsolutePath());
        }
