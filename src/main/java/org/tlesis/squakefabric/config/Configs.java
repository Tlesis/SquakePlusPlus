...
public class Configs implements IConfigHandler {
    ...
    public static class Generic {
        ...
        public static final ConfigDouble    MAX_AIR_ACCELERATION_PER_TICK = new ConfigDouble  ("maxAirAccelerationPerTick", 0.045, 0.0, 32767, "Limit for how much you can accelerate in a tick");
        public static final ConfigDouble    HARD_CAP_THRESHOLD            = new ConfigDouble  ("hardCapThreshold", 0.0, 0.0, 32767, "If you jump while above the hard cap speed (moveSpeed*hardCapThreshold), your speed is set to the hard cap speed");
        ...
        public static final ConfigDouble    SOFT_CAP_THRESHOLD            = new ConfigDouble  ("softCapThreshold", 1.4, 0.0, 32767, "See uncappedBunnyhopEnabled and softCapDegen; soft cap speed = (moveSpeed*softCapThreshold)");
